...
"    </thead>");
           ...
           // out.println("<tr class=\"warning\"><td>Total : </td><td></td><td> ₹ "+total+"</td></tr>");
            ...
            out.println("<a href='products.html'><input class=\"btn btn-primary\" type='submit' value='Continue shopping'></a><span style=\"display:inline-block; width:880px;\"></span><form method=\"post\" action=\"Confirm\"><input class=\"btn btn-primary\" type='submit' value='Confirm Order'></form>");
